      ...
      <Script
        ...
        onLoad={() => {
          window.botpress.init({
            "botId": "5da9f260-9745-4859-afc7-b0e40d628702",
            "configuration": {
              "botName": "quick-learn",
              "botDescription": "",
              "website": {},
            ...
            "clientId": "e804e7f2-5604-4080-9c7e-7ef71a3fbf97"
          });
        }}
      />
        ...
        <div className="w-1/4 bg-black/40 backdrop-blur-xl p-4 overflow-y-auto border-r border-white/10">
          ...
          {isLoading ? (
            ...
            workspaces.map((ws) => (
              <div
                key={ws._id}
                onClick={() => setSelectedWorkspaceId(selectedWorkspaceId == ws._id ? null: ws._id)}
                                      ...
                                      {currentModule === index &&
                                        canAccessModule(index) && (
                                          <div className="mt-4">
                                            ...
                                            {/* Slide Content */}
                                            <div className="bg-white/5 w-full h-[600px] max-w-4xl mx-auto p-10 rounded-xl mb-6 border border-white/10 flex items-center justify-center">
